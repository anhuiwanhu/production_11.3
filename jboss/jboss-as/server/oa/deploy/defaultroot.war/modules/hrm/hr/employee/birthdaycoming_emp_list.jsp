...
<body class="MainFrameBox">
	<s:form name="queryForm" id="queryForm" action="${ctx}/employee!birthdaycoming_emp_list_data.action" method="post" >
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="SearchBar" id="searchTable">  
        ...
        <tr>
            <td class="whir_td_searchtitle">出生日期：</td>
   ...
   <table width="100%" border="0" cellpadding="0" cellspacing="0" class="toolbarBottomLine">  
	...
	<s:form name="exportForm" id="exportForm" action="employee!birthdaycoming_emp_list_export.action" method="post">
	...
	function excelExport(){
		commonExportExcel({formId:'queryForm', action:'employee!birthdaycoming_emp_list_export.action' });
	}
