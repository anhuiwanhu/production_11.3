...
//页面各栏目对应的新建信息，传递标识判断是否是易播栏目
//String isyibo2 = request.getParameter("isyiboflag")!=null ? request.getParameter("isyiboflag"):"0";
%>
<body class="Pupwin">
...
$(document).ready(function(){
	...
	//初始化发布时间
	$("#informationIssueTime").val(getFormatDate(new Date(),"yyyy-MM-dd hh:mm:ss"));
