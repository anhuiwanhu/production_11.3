  ...
  <div id="docinfo2" style="display:none;">
	 ...
	 <table width="100%" border="0" cellpadding="2" cellspacing="1" class="Table_bottomline" >
		  <tr>
			...
			<td width="45%"> 
			<s:textfield name="processPO.formClassName" id="formClassName" cssClass="inputText" whir-options="vtype:[{'maxLength':50}],'promptText':'请输入名称'" cssStyle="width:96%;" /> 
			 </td>
			 <td width="110px">
				  <%-- <div style="margin-left:-1px;margin-top:10px">
					 <jsp:include page="/public/upload/uploadify/upload_include.jsp" flush="true">      
		  ...
		  <tr>
				...
				<td> 
				<s:textfield name="processPO.jsFileName" id="jsFileName" cssClass="inputText" whir-options="vtype:[{'maxLength':50}]" cssStyle="width:96%;"/></td>
				<td>
				  <%--<div style="margin-left:-1px;margin-top:10px">
		  ...
		  <tr>
				...
				<td> 
				<s:textfield name="processPO.jsFileName_phone" id="jsFileName_phone" cssClass="inputText" whir-options="vtype:[{'maxLength':50}]" cssStyle="width:96%;" /></td>
				<td>
				 <%-- <div style="margin-left:-1px;margin-top:10px">
					 <jsp:include page="/public/upload/uploadify/upload_include.jsp" flush="true">
					   <jsp:param name="onInit"             value="" /> 
