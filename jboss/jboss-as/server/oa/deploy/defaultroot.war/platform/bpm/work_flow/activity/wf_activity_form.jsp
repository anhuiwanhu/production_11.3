            ...
            <div id="docinfo0" style="display:;"  multiTag='yes' >
                <table width="100%" border="0" class="Table_bottomline" cellpadding="0" cellspacing="0">
				  ...
				  <tr>
					 ...
					 <td colspan=3><s:radio name="po.activityClass"  id="activityClass" list="%{#{1:getText('workflow.newactivitystandard'),0:getText('workflow.newactivityson'),2:getText('workflow.newactivityvirtual'),3:getText('workflow.newactivityautoback'),4:getText('workflow.forkActivity'),5:getText('workflow.joinActivity')}}" theme="simple"  onClick="changeActiClass();" ></s:radio> <span  id="joinApproveNumSpan" <%=joinApproveNumSpanDisplay%> ><s:text name="workflow.joinnum"/>： <s:textfield name="po.joinApproveNum" id="joinApproveNum" cssClass="inputText" whir-options="vtype:['p_integer',{'maxLength':8}]" cssStyle="width:14%;" /></span>
					 </td>
			     </tr>
				 ...
				 <tr id="subProcDiv0"   <%=subProcDivDisplay%> >
                     ...
                     <td>
                         <s:textfield name="po.activitySubProcName" id="activitySubProcName"   cssClass="inputText"  cssStyle="width:90%;" /><a href="#" class="selectIco" onclick="selectSubProc('activitySubProc','activitySubProcName');"><img src="<%=rootPath%>/images/select_arrow.gif" width="16" height="16" align="absmiddle"/></a> 
                                    ...
                                    <td colspan="2">
									    <table border="0" width="100%">
									      <tr>
											   ...
											   <td><bean:message bundle="workflow" key="workflow.methodName"/><!--方法名-->：</td>
											   <td>
											      <s:textfield name="po.passRoundUserMethodName" id="passRoundUserMethodName" cssClass="inputText" whir-options="vtype:[{'maxLength':100}]" cssStyle="width:40%;" />
											   </td>
											   <td></td>
										  </tr>
										   <tr>
	...
	if(participantTypevalue==3&&$("#allUserId").val()== ''){         
	 ...
	 if(participantTypevalue==16){
	  ...
	  if(needPassRound_val==1 &&passRoundUserTypevalue==13&& $("#passRoundGivenGroupName").val()== ''){
	   ...
	   var  para='activityId='+$("#wfActivityId").val()+'&activityName=' +encodeURI($("#activityName").val())
