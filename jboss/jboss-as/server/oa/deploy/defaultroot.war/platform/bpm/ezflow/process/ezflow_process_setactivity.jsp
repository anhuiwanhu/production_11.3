								...
								<table  id="dispTable"  border="0" cellspacing="0" cellpadding="0" class="SubTable" style="width:95%" >
									...
									<tr>
										...
										<td  class="subTitleList" ><select  name="customPressUserIds_select" id="customPressUserIds_select" class="selectlist"  style="width:120px;height:29px">
											...
											</select><input type="hidden"  name="dispTable_index"  value="0"><input type="hidden" name="customPressUserIds0" id="customPressUserIds0" value=""><input  name="customPressUserNames0" id="customPressUserNames0"    type="text" class="inputText"    style="width:40%" readonly><a href="#" class="selectIco" onclick="openSelect({allowId:'customPressUserIds0', allowName:'customPressUserNames0', select:'user', single:'yes', show:'userorggroup', range:'*0*'});"><img src="<%=rootPath%>/images/select_arrow.gif" width="16" height="16" align="absmiddle"/></a></td> 
										<td class="subTitleList" style="border-right:1px solid #d9d9d9; border-bottom:1px solid #d9d9d9; padding:4px;"  nowrap >
							...
							<tr>
								...
								<td>
										     ...
										     <table width="100%" cellpadding="0" cellspacing="0"  border="0"  style="margin-left:-4px;">
												...
												<tr id="hxr">
												  <td height="18"  nowrap>
												    <textarea   Class="inputTextarea"   rows="3"  style="width:93%;" readonly name="candidate" id="candidate"  ></textarea><a href="#" class="selectIco textareaIco" onclick="openSelect({allowId:'candidateId', allowName:'candidate', select:'user', single:'no', show:'usergroup', range:'*0*',key:'code'});"><img src="<%=rootPath%>/images/select_arrow.gif" width="16" height="16" align="absmiddle"/></a><span class="MustFillColor">*</span>
												...
												<tr id="zdzz">
												  <td>
													 ...
													 </textarea><a href="#" class="selectIco textareaIco" onclick="openSelect({allowId:'participantGivenOrg', allowName:'participantGivenOrgName', select:'user', single:'no', show:'orggroup', range:'*0*',key:'code'});"><img src="<%=rootPath%>/images/select_arrow.gif" width="16" height="16" align="absmiddle"/></a><span class="MustFillColor">*</span>
									   ...
									   <tr>
										...
										<tr id="passRoundxdqz" style="display:none">
											<td colspan="2">
											  ...
											  </textarea><a href="#" class="selectIco textareaIco" onclick="openSelect({allowId:'passRoundGivenGroup', allowName:'passRoundGivenGroupName', select:'group', single:'no', show:'group', range:'*0*',key:'code'});"><img src="<%=rootPath%>/images/select_arrow.gif" width="16" height="16" align="absmiddle"/></a><span class="MustFillColor">*</span>
										...
										<tr id="passRoundzdzz" style="display:none">
											<td>
												...
												</textarea><a href="#" class="selectIco textareaIco" onclick="openSelect({allowId:'passRoundGivenOrg', allowName:'passRoundGivenOrgName', select:'user', single:'no', show:'orggroup', range:'*0*',key:'code'});"><img src="<%=rootPath%>/images/select_arrow.gif" width="16" height="16" align="absmiddle"/></a><span class="MustFillColor">*</span>
							...
							<tr id="tranTR" style="display:none">
							 ...
							 <tr id="tranReadTR"  style="display:none">
							  ...
							  <tr>
								  ...
								  <td><INPUT TYPE="checkbox" NAME="operButton"  value="SynToInfo"><IMG SRC="images/toolbar/syncinfo.png" align="absmiddle">&nbsp;&nbsp;<bean:message bundle="workflow" key="workflow.SynToInfo"/>【<bean:message bundle="workflow" key="workflow.newactivitybuttoncommon"/>】 </td>
							  </tr>  
