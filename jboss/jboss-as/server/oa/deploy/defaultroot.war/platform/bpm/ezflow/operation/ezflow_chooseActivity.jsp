...
<%@page import="com.whir.ezflow.util.EzFlowUtil"%>
...
<%
    ...
    String msgFrom=request.getParameter("p_wf_msgFrom")==null?"工作流程":request.getParameter("p_wf_msgFrom").toString();
	String domainId=session.getAttribute("domainId")==null?"0":session.getAttribute("domainId").toString();
	String title="";  
    String _p_wf_titleFieldName=request.getParameter("p_wf_titleFieldName")==null?"":request.getParameter("p_wf_titleFieldName").toString();
 		
	if(EzFlowUtil.judgeNull(_p_wf_titleFieldName)&&EzFlowUtil.judgeNull(request.getParameter(_p_wf_titleFieldName))){
		title=request.getParameter(_p_wf_titleFieldName);
	}else{
