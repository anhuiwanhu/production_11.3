			   ...
			   <s:if test="from=='workflow'">
				...
				<s:else>
				    <s:if test="openType=='waitingDeal'">
						...
						<input name="" type="button" value='<s:text name="comm.recover1"/>' class="btnButton4font"  style="display:none" id="resetNoTreatmentButton" onClick="batchResetNoTreatment(this);" />
 ...
 <script type="text/javascript">  
	...
	*/
    function setRelation_(obj){
         ...
         var openurl="";
		 if(obj.isezFlow=="1"){
             openurl="ezflowopen!updateProcess.action?p_wf_processInstanceId="+obj.ezFlowProcessInstanceId+"&ezFlowProcessInstanceId="+obj.ezFlowProcessInstanceId+
