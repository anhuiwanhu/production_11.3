...
<div class="Public_tag">  
		<ul>  
			<li id="user_syn_log" onclick="userlist();"  ><span class="tag_center">用户同步日志</span><span class="tag_right"></span></li>
			<li id="org_syn_log" onclick="orglist();"  class="tag_aon"><span class="tag_center">组织同步日志</span><span class="tag_right"></span></li>
		</ul>  
	</div> 
<!--这里的表单id queryForm 允许修改 -->  
<s:form name="queryForm" id="queryForm" action="/MoveOAmanager!logList.action" method="post">
<input type="hidden" name="user_org_flag"  id="user_org_flag"  value="1" />
<!-- SEARCH PART START -->  
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="listTable">  
    ...
    <tr class="listTableHead">  
        ...
        <td whir-options="field:'event',width:'32%'">事件</td>   
        <td whir-options="field:'result', width:'48%'">结果</td> 
    </tr>
    </thead>  
