...
String mailNum = (String)sysSetupMap.get("mailNum");
        ...
        <table class="Table_bottomline" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr style="display:">
                ...
                <td nowrap="nowrap">
                    ...
                    <span id="historyMail_span" style="display:none"><select id="saveDays" name="saveDays" class="easyui-combobox" data-options="width:60">
                    ...
                    <select id="runHour" name="runHour" class="easyui-combobox" data-options="width:40">
            ...
            <tr style="display:">
                ...
                <td nowrap="nowrap">
                    ...
                    <span id="historyLog_span" style="display:none"><select id="logSaveDays" name="logSaveDays" class="easyui-combobox" data-options="width:40">
                    ...
                    <select id="logRunHour" name="logRunHour" class="easyui-combobox" data-options="width:40">
                    <%for(int sTime=0;sTime<24;sTime++){%>
            ...
            <tr style="display:">
                ...
                <td>Html编辑器默认字体：</td>
                <td>
                    <select id="fontType" name="fontType" class="easyui-combobox" style="width:125px;">
            ...
            <tr style="display:none;">
                ...
                <td>
                    ...
                    开启时间:
                    <select id="startTime_HH" name="startTime_HH" class="easyui-combobox" data-options="width:40">
                    <%for(int i=0;i<24;i++){
                    ...
                    <select id="startTime_mm" name="startTime_mm" class="easyui-combobox" data-options="width:40">
                    <%for(int i=0;i<60;i++){
                    String ii = ((i+"").length()<2)?"0"+i:""+i;
                    %>
                    ...
                    结束时间:
                    <select id="endTime_HH" name="endTime_HH" class="easyui-combobox" data-options="width:40">
                    <%for(int i=0;i<24;i++){
                    String ii = ((i+"").length()<2)?"0"+i:""+i;
                    %>
                    ...
                    <select id="endTime_mm" name="endTime_mm" class="easyui-combobox" data-options="width:40">
                    <%for(int i=0;i<60;i++){
                    String ii = ((i+"").length()<2)?"0"+i:""+i;
                    %>
...
function save() {
    if (isNaN($('#wordlimitsize').val()) || parseInt($('#wordlimitsize').val()) < 0) {
    ...
    var worklog = $('#worklog').val();
    if ($('#worklog_rad1').attr('checked') == 'checked' && (isNaN(worklog) || parseInt(worklog) < 0 || worklog == 'e' || worklog.indexOf('.')!=-1)) {
    ...
    if ($('#attachLimit1').attr('checked') == 'checked') {
        if (isNaN($('#attachLimitSize').val()) || parseInt($('#attachLimitSize').val()) < 0 || $('#attachLimitSize').val().indexOf(".") >= 0) {
